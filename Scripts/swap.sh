...
wget -O /usr/local/bin/install_cp_plugin "https://raw.githubusercontent.com/SolusTec/NuoPanel/main/Scripts/install_cp_plugin?$(date +%s)"
...
chmod +x /usr/local/bin/olspanel
        ...
        if [ ! -f "$roundcube" ]; then
            install_cp_plugin https://raw.githubusercontent.com/SolusTec/NuoPanel/main/Assets/roundcube.zip
        fi

        if [ ! -f "$rainloop" ]; then
            install_cp_plugin https://raw.githubusercontent.com/SolusTec/NuoPanel/main/Assets/rainloop.zip
        fi

install_cp_plugin https://raw.githubusercontent.com/SolusTec/NuoPanel/main/Assets/phpmyadmin.zip